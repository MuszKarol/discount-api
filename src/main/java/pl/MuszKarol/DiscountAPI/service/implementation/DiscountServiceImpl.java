...
import pl.MuszKarol.DiscountAPI.util.converter.FileConverter;
...
public class DiscountServiceImpl implements DiscountService {
    ...
    private boolean saveImage(MultipartFile image, Discount discount, String imageExtension) {
        File file = fileManager.getNewFile("discount_image_" + discount.getId(), imageExtension);
        return FileConverter.convertMultipartFileToFile(image, file);
    }
