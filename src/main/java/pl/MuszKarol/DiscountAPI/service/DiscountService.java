...
public interface DiscountService {
    ...
    DiscountDTOResponse saveDiscount(MultipartFile multipartFile, DiscountDTORequest discountDTORequest) throws FileUploadException, InvalidImageExtensionException;
